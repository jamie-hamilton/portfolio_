...
ALLOWED_HOSTS = ['jh-portfolio-app.herokuapp.com', '127.0.0.1']
...
if not DEBUG:
    ...
    AWS_S3_CUSTOM_DOMAIN = '%s.s3.amazonaws.com' % AWS_STORAGE_BUCKET_NAME # Tell django-storages the domain to use to refer to static files.
